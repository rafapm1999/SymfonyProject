...
{
    #[Route('/', name: 'app_admin_etiqueta_index', methods: ['GET'])]
    ...
    #[Route('/new', name: 'app_admin_etiqueta_new', methods: ['GET', 'POST'])]
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_admin_etiqueta_index', [], Response::HTTP_SEE_OTHER);
        }

        return $this->render('admin/etiqueta/new.html.twig', [
            'etiquetum' => $etiquetum,
            'form' => $form,
        ]);
    }

    #[Route('/{id}', name: 'app_admin_etiqueta_show', methods: ['GET'])]
    ...
    #[Route('/{id}/edit', name: 'app_admin_etiqueta_edit', methods: ['GET', 'POST'])]
    public function edit(Request $request, Etiqueta $etiquetum, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('admin/etiqueta/edit.html.twig', [
            'etiquetum' => $etiquetum,
            'form' => $form,
        ]);
    }

    #[Route('/{id}', name: 'app_admin_etiqueta_delete', methods: ['POST'])]
